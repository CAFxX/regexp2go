...
// regexp2go -flags=212 -pkg="commonregex" -fn="SHA1Hex" -pool=true "[0-9a-fA-F]{40}"
...
const SHA1HexRegexp = "[0-9a-fA-F]{40}"
...
type modeTypeSHA1Hex uint8

const (
	modeMatchSHA1Hex modeTypeSHA1Hex = iota
	modeFirstSHA1Hex
	modeLongestSHA1Hex
)

// SHA1Hex implements the regular expression
// [0-9a-fA-F]{40}
// with flags 212.
type SHA1Hex struct{}
type stateSHA1Hex struct {
	c   [2]int
	i   int
	pc  int
	cnt int
...
func (e SHA1Hex) FindString(r string) (matches [1]string, pos int, ok bool) {
	var bt [0]stateSHA1Hex // static storage for backtracking state
	matches, pos, ok = e.doString(r, modeFirstSHA1Hex, bt[:0])
	return
}

// FindLongestString returns the leftmost-longest match.
func (e SHA1Hex) FindLongestString(r string) (matches [1]string, pos int, ok bool) {
	var bt [0]stateSHA1Hex // static storage for backtracking state
	matches, pos, ok = e.doString(r, modeLongestSHA1Hex, bt[:0])
	return
}

// Find returns the first leftmost match.
func (e SHA1Hex) Find(s []byte) (matches [1][]byte, pos int, ok bool) {
	var bt [0]stateSHA1Hex // static storage for backtracking state
	matches, pos, ok = e.doByteSlice(s, modeFirstSHA1Hex, bt[:0])
	return
}

// FindLongest returns the leftmost-longest match.
func (e SHA1Hex) FindLongest(s []byte) (matches [1][]byte, pos int, ok bool) {
	var bt [0]stateSHA1Hex // static storage for backtracking state
	matches, pos, ok = e.doByteSlice(s, modeLongestSHA1Hex, bt[:0])
	return
}

func (e SHA1Hex) doByteSlice(s []byte, m modeTypeSHA1Hex, bt []stateSHA1Hex) (matches [1][]byte, pos int, ok bool) {
	var r string
...
func (e SHA1Hex) doString(s string, m modeTypeSHA1Hex, bt []stateSHA1Hex) (matches [1]string, pos int, ok bool) {
	var pmatches [1 * 2]int
...
func (e SHA1Hex) do(r string, m modeTypeSHA1Hex, bt []stateSHA1Hex) ([2]int, bool) {
...
match:
	if !matched || c[1]-c[0] > bc[1]-bc[0] {
		if m == modeMatchSHA1Hex || m == modeFirstSHA1Hex {
			return c, true
		}
		bc = c
		matched = true
