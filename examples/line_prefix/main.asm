...
restart:
  ...
  0x275d		4939f3			CMPQ SI, R11		
  0x2760		0f8dab040000		JGE 0x2c11		
		cr, sz := rune(r[i]), 1
...
TEXT type..eq.[2]string(SB) gofile..<autogenerated>
  ...
  0x40a2		64488b0c2500000000	MOVQ FS:0, CX			[5:9]R_TLS_LE		
  0x40ab		483b6110		CMPQ 0x10(CX), SP		
  0x40af		0f86a6000000		JBE 0x415b			
  0x40b5		4883ec30		SUBQ $0x30, SP			
  0x40b9		48896c2428		MOVQ BP, 0x28(SP)		
  0x40be		488d6c2428		LEAQ 0x28(SP), BP		
  0x40c3		488b442438		MOVQ 0x38(SP), AX		
  0x40c8		488b4808		MOVQ 0x8(AX), CX		
  0x40cc		488b542440		MOVQ 0x40(SP), DX		
  0x40d1		48394a08		CMPQ CX, 0x8(DX)		
  0x40d5		7575			JNE 0x414c			
  0x40d7		488b4a18		MOVQ 0x18(DX), CX		
  0x40db		48394818		CMPQ CX, 0x18(AX)		
  0x40df		756b			JNE 0x414c			
  0x40e1		31c9			XORL CX, CX			
  0x40e3		eb13			JMP 0x40f8			
  0x40e5		488b5c2420		MOVQ 0x20(SP), BX		
  0x40ea		488d4b01		LEAQ 0x1(BX), CX		
  0x40ee		488b442438		MOVQ 0x38(SP), AX		
  0x40f3		488b542440		MOVQ 0x40(SP), DX		
  0x40f8		4883f902		CMPQ $0x2, CX			
  0x40fc		7d3f			JGE 0x413d			
  0x40fe		48894c2420		MOVQ CX, 0x20(SP)		
  0x4103		48c1e104		SHLQ $0x4, CX			
  0x4107		488b3411		MOVQ 0(CX)(DX*1), SI		
  0x410b		488b3c01		MOVQ 0(CX)(AX*1), DI		
  0x410f		488b4c0808		MOVQ 0x8(AX)(CX*1), CX		
  0x4114		48893c24		MOVQ DI, 0(SP)			
  0x4118		4889742408		MOVQ SI, 0x8(SP)		
  0x411d		48894c2410		MOVQ CX, 0x10(SP)		
  0x4122		e800000000		CALL 0x4127			[1:5]R_CALL:runtime.memequal	
  0x4127		807c241800		CMPB $0x0, 0x18(SP)		
  0x412c		75b7			JNE 0x40e5			
  0x412e		c644244800		MOVB $0x0, 0x48(SP)		
  0x4133		488b6c2428		MOVQ 0x28(SP), BP		
  0x4138		4883c430		ADDQ $0x30, SP			
  0x413c		c3			RET				
  0x413d		c644244801		MOVB $0x1, 0x48(SP)		
  0x4142		488b6c2428		MOVQ 0x28(SP), BP		
  0x4147		4883c430		ADDQ $0x30, SP			
  0x414b		c3			RET				
  0x414c		c644244800		MOVB $0x0, 0x48(SP)		
  0x4151		488b6c2428		MOVQ 0x28(SP), BP		
  0x4156		4883c430		ADDQ $0x30, SP			
  0x415a		c3			RET				
  0x415b		e800000000		CALL 0x4160			[1:5]R_CALL:runtime.morestack_noctxt	
  0x4160		6690			NOPW				
  0x4162		e93bffffff		JMP type..eq.[2]string(SB)	
